...
var fs = require('fs');
stat = fs.stat;
delDir("./views/webfunny_center")
fs.mkdir( "./views/webfunny_center", function(err){
  if ( err ) { 
...
// 生成探针结束
copy("./views/resource/", "./views/webfunny_center")
copy("./views/images/", "./views/webfunny_center")
console.log("= 正在执行编译，请稍等...")
setTimeout(function() {
  let path = './views/webfunny_center/js';
